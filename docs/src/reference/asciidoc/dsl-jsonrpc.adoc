...
----
include::samples/src/test/java/org/springframework/dsl/jsonrpc/docs/ControllerDocs.java[tags=snippet1]
----
...
[source,java,indent=0]
----
include::samples/src/test/java/org/springframework/dsl/jsonrpc/docs/ControllerDocs.java[tags=snippet2]
----
...
[source,java,indent=0]
----
include::samples/src/test/java/org/springframework/dsl/jsonrpc/docs/ControllerDocs.java[tags=snippet3]
----
