 ...
 *
 */
public interface ServerLspExchange {

	/**
	 * Return the current {@code LSP} request.
	 *
	 * @return the current request
	 */
	ServerLspRequest getRequest();

	/**
	 * Return the current {@code LSP} response.
	 *
	 * @return the current response
	 */
	ServerLspResponse getResponse();
}
